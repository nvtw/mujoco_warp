...
def build_ccd_generic(support_func: Any):
  ...
  @wp.func
  def _gjk(
    tolerance: float, gjk_iterations: int, geom1: Any, geom2: Any, x1_0: wp.vec3, x2_0: wp.vec3, geomtype1: int, geomtype2: int
  ):
  ...
  def _test_tetra(p0: wp.vec3, p1: wp.vec3, p2: wp.vec3, p3: wp.vec3):
    return (
      _same_side(p0, p1, p2, p3) and _same_side(p1, p2, p3, p0) and _same_side(p2, p3, p0, p1) and _same_side(p3, p0, p1, p2)
    )
  ...
  @wp.func
  def _epa(tolerance2: float, epa_iterations: int, pt: Polytope, geom1: Any, geom2: Any, geomtype1: int, geomtype2: int):
